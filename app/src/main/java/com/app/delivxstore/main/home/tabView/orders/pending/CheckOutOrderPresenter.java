...
package com.app.delivxstore.main.home.tabView.orders.pending;
 ...
 * implementation
 */
public class CheckOutOrderPresenter implements CheckOutContract.PresenterOperations {
  @Inject
  Utility utility;
  @Inject
  Context context;
  ...
  private CheckOutContract.ViewOperations mView;
  ...
  Observer<Data> observer = new Observer<Data>() {
    ...
    public void onNext(Data value) {
      getCheckoutOrderApi(ZERO, LIMIT);
    }
  ...
  @Override
  public void attachView(CheckOutContract.ViewOperations viewOperations) {
   ...
   */
  @Override
  public void getCheckoutOrderApi(int skip, int limit) {
              ...
              case SUCCESS:
                try {
                  ...
                  if (skip == ZERO && limit == LIMIT) {
                    mView.setListData(mOrderData.getData(), CHECKED,
