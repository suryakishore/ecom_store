 ...
 */
public class DriverAssignedFragment extends DaggerFragment implements
    DriverAssignContract.ViewOperations, TextWatcher {
  @Inject
  DriverAssignContract.PresenterOperations presenter;
  ...
  private void initView() {
    ...
    mBinding.swipeRefreshLayout.setOnRefreshListener(() -> {
      presenter.getDriverAssignOrderApi(ZERO, LIMIT);
  ...
  public void setListData(ArrayList<Data> orders, int status, int penCount, int driverCount,
        ...
        new MyScrollListener(layoutManager) {
          ...
          protected void loadMoreItems() {
            ...
            if (orderDetails.size() < mPenCount) {
              ...
              presenter.getDriverAssignOrderApi(
                  orderDetails.size(),
                  LIMIT);
            }
          }
    ...
    if (parentFrag != null) {
      parentFrag.setAssignTabCount(driverCount);
    }
  }
