 ...
 */
@Module
public abstract class NewOrdersModule {

    @FragmentScoped
    @ContributesAndroidInjector
    abstract NewOrdersFragment orderFragment();

    @ActivityScoped
    @Binds
    abstract NewOrderContract.PresenterOperations getOrderpresenter(NewOrderPresenter presenter);
}
