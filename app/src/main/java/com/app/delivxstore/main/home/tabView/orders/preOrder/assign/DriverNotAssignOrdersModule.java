...
@Module
public abstract class DriverNotAssignOrdersModule {
  @FragmentScoped
  @ContributesAndroidInjector
  abstract DriverNotAssignedFragment orderFragment();

  @ActivityScoped
  @Binds
  abstract DriverNotAssignContract.PresenterOperations getOrderPresenter(
      DriverNotAssignOrderPresenter presenter);
}
