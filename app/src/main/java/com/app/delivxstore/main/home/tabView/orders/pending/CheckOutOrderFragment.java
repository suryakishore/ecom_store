 ...
 * view
 */
public class CheckOutOrderFragment extends DaggerFragment implements
    CheckOutContract.ViewOperations, TextWatcher {
  @Inject
  public CheckOutContract.PresenterOperations presenter;
  ...
  private void initView() {
    ...
    mBinding.swipeRefreshLayout.setOnRefreshListener(() -> {
      ...
      presenter.getCheckoutOrderApi(ZERO, LIMIT);
  ...
  @Override
  public void setListData(ArrayList<Data> newOrderList, int status, int penCount,
      boolean isCityLogin) {
    mPenCount = penCount;
    mBinding.swipeRefreshLayout.setRefreshing(FALSE);
