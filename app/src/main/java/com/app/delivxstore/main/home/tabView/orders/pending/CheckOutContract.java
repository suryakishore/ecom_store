...
public interface CheckOutContract {
  ...
  interface ViewOperations extends BaseView {
     ...
     */
    void setListData(ArrayList<Data> newOrderList, int status, int penCount, boolean isCityLogin);
  ...
  interface PresenterOperations {
     ...
     */
    void attachView(
        CheckOutContract.ViewOperations viewOperations);

    void getCheckoutOrderApi(int skip, int limit);
