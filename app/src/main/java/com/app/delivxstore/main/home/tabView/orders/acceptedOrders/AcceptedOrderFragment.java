 ...
 */
public class AcceptedOrderFragment extends DaggerFragment implements
    AcceptedOrderContract.ViewOperations, TextWatcher {
  @Inject
  AcceptedOrderContract.PresenterOperations presenter;
  ...
  private void initView() {
    ...
    mBinding.swipeRefreshLayout.setOnRefreshListener(() -> {
      presenter.getAcceptedOrderApi(ZERO, LIMIT);
        ...
        new MyScrollListener(layoutManager) {
          ...
          protected void loadMoreItems() {
            ...
            if (mOrderDetails.size() < mPenCount) {
              ...
              presenter.getAcceptedOrderApi(
                  mOrderDetails.size(),
                  mOrderDetails.size() + LIMIT);
            }
          }
