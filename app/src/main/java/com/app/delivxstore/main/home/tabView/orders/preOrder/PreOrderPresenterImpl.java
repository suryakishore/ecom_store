 ...
 */
public class PreOrderPresenterImpl implements PreOrderConrtact.PreOrderPresenter {
  @Inject
  Utility utility;
  @Inject
  Context context;
  ...
  private PreOrderConrtact.PreOrderView mView;
  private String mTitle = "";
  private OrderData mOrderData;
  private Gson mGson = new Gson();

  @Inject
  public PreOrderPresenterImpl() {
  }
  ...
  @Override
  public void attachView(PreOrderFragment viewOperations) {
