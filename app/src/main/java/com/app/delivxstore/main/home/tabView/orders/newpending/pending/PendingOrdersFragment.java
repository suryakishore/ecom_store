 ...
 * view
 */
public class PendingOrdersFragment extends DaggerFragment implements
    PendingOrderContract.ViewOperations,
    TextWatcher {
  @Inject
  public PendingOrderContract.PresenterOperations presenter;
  ...
  @Override
  public void setListData(ArrayList<Data> newOrderList, int status, int penCount, int pendingCount,
      boolean isCityLogin) {
    mPenCount = penCount;
    mBinding.swipeRefreshLayout.setRefreshing(FALSE);
    ...
    if (parentFrag != null) {
      parentFrag.setPendingTabCount(pendingCount);
    }
  }
