 ...
 * implementation
 */
public class NewOrderPresenter implements NewOrderContract.PresenterOperations {
  @Inject
  Utility utility;
  @Inject
  Context context;
  ...
  private NewOrderContract.ViewOperations mView;
  ...
  @Override
  public void attachView(NewOrderContract.ViewOperations viewOperations) {
