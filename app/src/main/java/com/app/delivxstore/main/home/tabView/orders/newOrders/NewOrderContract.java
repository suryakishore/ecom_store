...
public interface NewOrderContract {
  ...
  interface ViewOperations extends BaseView {
     ...
     */
    void setListData(ArrayList<Data> newOrderList, int status, int penCount, int newCount ,boolean isCityLogin);
  ...
  interface PresenterOperations {
     ...
     */
    void attachView(NewOrderContract.ViewOperations viewOperations);
