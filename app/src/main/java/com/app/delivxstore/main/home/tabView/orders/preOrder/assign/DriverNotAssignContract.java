 ...
 * for accepted order
 */
public interface DriverNotAssignContract {
  /**
  ...
  interface PresenterOperations {
    ...
    void attachView(DriverNotAssignContract.ViewOperations viewOperations);

    void getDriverNotAssignOrderApi(int skip, int limit);
//        void getOrders();
