...
package com.app.ecomstore.uiutil.barcodescanning.camera;
...
import com.app.ecomstore.uiutil.barcodescanning.graphic.VisionImageProcessor;
...
public class CameraSource {
   ...
   *
   * @return it will return the camera instance.
   */
